...
return array(
//网站路径
'web_path' => '/zy/admin/phpsso_server/',
//Session配置
...
'js_path' => 'http://localhost/zy/admin/phpsso_server/statics/js/', //CDN JS
'css_path' => 'http://localhost/zy/admin/phpsso_server/statics/css/', //CDN CSS
'img_path' => 'http://localhost/zy/admin/phpsso_server/statics/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => 'http://localhost/zy/admin/phpsso_server/',//动态域名配置地址
